...
const jump = mario => {
  return {
    ...
    animate(
      ...
      let forceX = walking ? interpolateX(percent) * (direction === 'right' ? 1 : -1) : 0;
...
export default (entities, {events}) => {
  ...
  mario.body.collisionFilter.mask = collisionsCategories.barrier | collisionsCategories.platform | collisionsCategories.barrel;
